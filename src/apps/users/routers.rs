use crate::apps::users::handlers::{
    __path_create_user, __path_delete_user, __path_get_user, __path_list_users, __path_update_user,
};
use crate::apps::users::handlers::{create_user, delete_user, get_user, list_users, update_user};
use actix_web::web;
use utoipa::OpenApi;

#[derive(OpenApi)]
#[openapi(paths(create_user, list_users, get_user, update_user, delete_user))]
